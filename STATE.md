# Portfolio — Estado Atual

## Sistema de Checkpoint
- Arquivo mestre: `STATE.md` (este arquivo)
- Projeto em: `/home/rafa/projects/portfolio/`
- Repo remoto: `git@github.com:Viiotti/portifolio.git`
- Site no ar: `https://viiotti.github.io/portifolio`
- Para retomar: leia este arquivo + o README.md do projeto

## Progresso

| # | Feature | Status | Arquivo | Commit |
|---|---------|--------|---------|--------|
| 1 | Estrutura base HTML | FEITO | index.html | c443956 |
...
2. Identifique a feature com status PENDENTE mais acima
3. Continue a partir do passo indicado
4. Atualize este arquivo ao concluir cada feature

## Comando Rápido de Retomada
```
cat /home/rafa/projects/portfolio/STATE.md
```
